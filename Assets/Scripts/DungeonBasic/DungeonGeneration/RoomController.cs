    ...
    public class RoomController : MonoBehaviour
    {
        ...
        public int Score {
            ...
            private set
            {
                ...
                if (value == 1)
                {
                    Success.SuccessHandler.Instance.UnlockAchievment(39);
                }
                else if (value == 5)
                {
                    Success.SuccessHandler.Instance.UnlockAchievment(40);
                }
                else if(value == scoreMax)
                {
                    Success.SuccessHandler.Instance.UnlockAchievment(41);
                }
            }
        }
        ...
        public void OnPlayerEnterRoom(Room room)
        {
            CameraController.instance.currRoom = room;
            currRoom = room;
            //if (currRoom.puzzleManager && !currRoom.Completed)
            if (!currRoom.Completed)
            {
                currRoom.ActivatePuzzle();
            }
            // TODO start puzzle here
