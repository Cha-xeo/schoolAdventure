...
public class InputManager : MonoBehaviour
{
    ...
    {
        //Debug.Log("Cam switched manualy");
        _camera = Camera.main;
    }
    ...
    {
        if (!_camera && _useMainCam) _camera = Camera.main;
    ...
    public void MenuPressed(InputAction.CallbackContext context)
    {
        if (context.performed)
        {
            UISettingsCanvas.GetInstance().CallMenu();
    ...
    {
        bool result = _tabPressed;
        _tabPressed = false;
        return result;
    }

    public void LeftShiftPressed(InputAction.CallbackContext context)
    {
        if (context.performed)
        {
    ...
    public bool GetLeftShiftPressed()
    {
        bool result = _leftShiftPressed;
        _leftShiftPressed = false;
        return result;
    }
