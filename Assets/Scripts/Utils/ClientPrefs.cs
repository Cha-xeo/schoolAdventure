...
namespace SchoolAdventure.Utils
{
    ...
    public static class ClientPrefs
    {
        ...
        const float k_DefaultEffectVolume = 0.4f;
        ...
        {
            return PlayerPrefs.GetFloat(k_EffectVolumeKey, k_DefaultEffectVolume);
        }

        public static void SetEffectVolume(float volume)
        {
            PlayerPrefs.SetFloat(k_EffectVolumeKey, volume);
        }
