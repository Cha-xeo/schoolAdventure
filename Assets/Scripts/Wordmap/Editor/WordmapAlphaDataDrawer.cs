...
[CustomEditor(typeof(WordmapAlphaData))]
[CanEditMultipleObjects]
[System.Serializable]
public class WordmapAlphaDataDrawer : Editor
{
    private ReorderableList AlphabetPlainList;
    private ReorderableList AlphabetNormalList;
    private ReorderableList AlphabetHighlightList;
    private ReorderableList AlphabetWrongList;

    private void OnEnable()
    {
        InitializedReorderableList(ref AlphabetPlainList, "AlphabetPlain", "Alphabet Plain");
        InitializedReorderableList(ref AlphabetNormalList, "AlphabetNormal", "Alphabet Normal");
        InitializedReorderableList(ref AlphabetHighlightList, "AlphabetHighlight", "Alphabet Highlight");
        InitializedReorderableList(ref AlphabetWrongList, "AlphabetWrong", "Alphabet Wrong");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        AlphabetHighlightList.DoLayoutList();
