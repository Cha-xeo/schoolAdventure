...
public class WordmapSearchingWordsList : MonoBehaviour
{
    ...
    private void CreatewordObjects()
    {
        ...
        for (var index = 0; index < _wordsNumber; index++) {
            ...
            _words[index].GetComponent<WordmapSearchingWord>().SetWord(currentGameData.selectedBoardData.SearchWords[index].Word);
        }
    }
